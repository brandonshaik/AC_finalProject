...
vis.append("svg:line").attr("x1", x(startYear)).attr("y1", y(startSeeker-1)).attr("x2", x(2013)).attr("y2", y(startSeeker)).attr("class", "axis")
vis.append("svg:line").attr("x1", x(startYear)).attr("y1", y(startSeeker-1)).attr("x2", x(startYear)).attr("y2", y(endSeeker)).attr("class", "axis")
